...
# Asynchronous function to send individual packet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--processes', default=10, type=int, help='Number of processes to run in parallel')
    parser.add_argument('--threads', default=50, type=int, help='Number of threads per process')
